...
router.put('/account/update/:_id',mdw.api_auth, upload.single("image"), accountCtrl.UpdateUser);
router.put('/account/:_id/upload/avatar',mdw.api_auth, upload.single("image"), accountCtrl.UploadAvatar);
...
router.put('/product/:_id/edit/favorite/:is_favorite',mdw.api_auth, pCtrl.UpdateFavorite);
...
router.put('/cart/:_id/update/:newQuantity', mdw.api_auth, cartCtrl.UpdateCartQuantity);
